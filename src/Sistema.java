...
public class Sistema {
	...
	public void mudarPasta() {
		...
		for(int i=0; i<this.arquivos.size(); i++) {
			if(this.arquivos.get(i).getExtensao().equals("pasta")) {
				if(this.arquivos.get(i).getNome().equals(pasta) && this.arquivos.get(i).getPasta().equals(this.pastaAtual)) {
	...
	public void voltarPasta() {
		...
		for(int i=0; i<this.arquivos.size(); i++) {
			if(this.arquivos.get(i).getExtensao().equals("pasta")) {
				if(this.arquivos.get(i).getNome().equals(pasta) && this.arquivos.get(i).getPasta().equals(pastaVoltar)) {
	...
	public void verPasta() {
		...
		for(int i=0; i<this.arquivos.size(); i++) {
			if(this.arquivos.get(i).getPasta().equals(this.pastaAtual)) {
				System.out.println(this.arquivos.get(i).getNome()+" --------------------------- "+this.arquivos.get(i).getTamanho()+"B");
			}
		}
		System.out.println();
	}
	...
	public Integer addDisco(Arquivo arquivo) {
		...
		if (isCompactar(arquivo.getTamanho())) {
			compactar();
		}
